...
public class PurchaseItem implements Serializable{
	...
	public PurchaseItem(Purchase purchase, Product product, Double discount, Double quantity, String name, String barcode,
			String reference, String description, @NotNull Double purchasePrice, @NotNull Double salePrice,
			@NotNull String un) {
		super();
